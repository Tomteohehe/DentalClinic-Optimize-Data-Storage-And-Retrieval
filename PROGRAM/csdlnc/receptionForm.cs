...
namespace csdlnc
{
    public partial class receptionForm : Form
    {
        ...
        string id_qtv;
        string currID;
        public receptionForm(string accId)
        {
            InitializeComponent();
            gridInit("");
        ...
        private void gridInit(string query)
        {
            ...
            cmd.CommandText = "SELECT * FROM TaiKhoan WHERE TypeTaiKhoan = 'NV' AND (HoTen LIKE @query OR SDT LIKE @query )";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add("NgaySinh", SqlDbType.DateTime).Value = dateTimePicker1.Value;
            cmd.Parameters.Add("GioiTinh", SqlDbType.NVarChar).Value = textBox7.Text;
            cmd.Parameters.Add("TypeTaiKhoan", SqlDbType.NVarChar).Value = "NV";
            ...
            MessageBox.Show("Tao moi nhan vien thanh cong");
            gridInit(textBox9.Text);
            con.Close();
        }
